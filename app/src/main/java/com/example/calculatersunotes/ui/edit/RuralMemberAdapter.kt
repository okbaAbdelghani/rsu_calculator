...
class RuralMemberAdapter(private var members: MutableList<RuralMember>) : RecyclerView.Adapter<RuralMemberAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RuralMemberAdapter.ViewHolder {
